...
export const listPendingTransactionsRequest = async () => {
    try {
        ...
        throw new Error(
            error?.response?.data?.message || "Error al listar las transacciones pendientes"
        );
    }
};
export const createPendingTransactionRequest = async (data: {
    ...
    try {
        ...
        throw new Error(
            error?.response?.data?.message || "Error al crear la transacción pendiente"
        );
    }
};
export const deletePendingTransactionRequest = async (id: string) => {
    try {
        ...
        throw new Error(
            error?.response?.data?.message || "Error al eliminar la transacción pendiente"
        );
    }
};
export const updatePendingTransactionRequest = async (
    ...
    try {
        ...
        throw new Error(
            error?.response?.data?.message || "Error al actualizar la transacción pendiente"
        );
    }
};