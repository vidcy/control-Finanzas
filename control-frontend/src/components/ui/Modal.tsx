    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
            ...
            >
                {/* HEADER */}
                {title && (
                    <div className="flex-shrink-0 flex items-center justify-between p-7 border-b border-gray-100 bg-white/80 backdrop-blur-sm z-10">
                ...
                {/* BODY */}
                <div className="p-8 overflow-y-auto custom-scrollbar flex-1 relative bg-gradient-to-b from-white to-gray-50/30">
                    {children}
                </div>
            </div>
        </div>,
